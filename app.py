...
# Load data
df_engagement = pd.read_csv('data/user_engagement_aggregated.csv')
df_experience = pd.read_csv('data/user_experience_aggregated.csv')
df_satisfaction = pd.read_csv('data/user_satisfaction_scores.csv')
